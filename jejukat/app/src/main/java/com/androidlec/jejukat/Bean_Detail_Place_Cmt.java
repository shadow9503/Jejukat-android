...
public class Bean_Detail_Place_Cmt {
...
//    private String contents_comment_tv;
    ...
    //Constructor
    //일정 데이터
    public Bean_Detail_Place_Cmt(int seq_cmt, int seq_post, String seq_user, String nickname, String picture, String comment, String date, int validation) {
