...
public class NetworkTask_DetailSchedule_Ins_Cmt extends AsyncTask<Integer, String, Void> {
    ...
    public NetworkTask_DetailSchedule_Ins_Cmt(Context context, String mAddr) {
