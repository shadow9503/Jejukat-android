...
public class NetworkTask_Select_Comment extends AsyncTask<Integer, String, Object> {
    ...
    ArrayList<Bean_Comment> comments;

    public NetworkTask_Select_Comment(Context context, String mAddr) {
        this.context = context;
        this.mAddr = mAddr;

        this.comments = new ArrayList<Bean_Comment>();
    }
    ...
    protected void Parser(String str) {
        ...
        try {
            ...
            JSONArray jsonArray = new JSONArray(jsonObject.getString("comments_info"));// JSONArray 로 불러오고
            Log.v( "Current", "arr" );
            comments.clear();
            ...
            for (int i = 0 ; i < jsonArray.length() ; i++) {
                ...
                comments.add(new Bean_Comment(seq_cmt, seq_post, seq_user, nickname,  picture,  comment,  date, validation));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
