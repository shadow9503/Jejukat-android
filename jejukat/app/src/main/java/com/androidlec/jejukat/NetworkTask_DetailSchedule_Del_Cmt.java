...
public class NetworkTask_DetailSchedule_Del_Cmt extends AsyncTask<Integer, String, Void> {
    ...
    public NetworkTask_DetailSchedule_Del_Cmt(Context context, String mAddr) {
